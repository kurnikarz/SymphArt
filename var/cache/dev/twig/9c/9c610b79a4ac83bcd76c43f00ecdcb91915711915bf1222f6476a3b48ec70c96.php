...
class __TwigTemplate_e74359e6b1c6b0b6f9a002014947f1a68dfcd02a97b6e416c9a1e920e7c7f2ff extends Template
{
    private $source;
    private $macros = [];
    ...
    <p>";
        // line 7
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 7, $this->source); })()), "body", [], "any", false, false, false, 7), "html", null, true);
        echo "</p>
    <hr>
    <a href=\"/\">Go Back</a>
";
